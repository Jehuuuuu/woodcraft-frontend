      ...
      <div className="max-w-6xl mx-auto pt-10 ">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center ">
            <Link href="/catalog" className="bg-[var(--primary-color)] text-white px-6 py-3 rounded flex items-center justify-center hover:bg-[var(--secondary-color)] transition-colors">
              Explore Collection
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
            </Link>
            <Link href="/configurator" className="border border-[#8B4513] text-[#8B4513] px-6 py-3 rounded flex items-center justify-center hover:bg-[#f0e6d9] transition-colors">
              Custom Design
            </Link>
          </div>
        </div>
